...
|---|---|---|
| 2025.04 | 웹 크롤링 기반 쇼핑몰(https://github.com/J1nYY/Shopping-Mall) | - 프로젝트 설계 <br>- 논문 작성 <br>- 메인 엔진 구현(Sellenium) <br>- 검색엔진 구현(Elastic search) <br>- 코드 통합 및 테스트&디버그 <br>|
---
### Ai 로봇 개발자
| Date | Project | Role & Description |
|---|---|---|
| 2025.10 | 레미 시각장애인 주방도구 위험감지 객체인식 | - 데이터 증강 <br>- Yolo 최적화 <br>- 코드 통합 및 테스트 & 디버그 <br>|
